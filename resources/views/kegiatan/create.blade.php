...
<div class="container" style="padding:20px; max-width:700px; margin:auto; font-family:Arial, sans-serif;">
    ...
    <h2 style="font-weight:700; font-size:2rem; margin-bottom:20px; color:#333;">Tambah Kegiatan</h2>
    ...
    <form action="{{ route('kegiatan.store') }}" method="POST" enctype="multipart/form-data"
        ...
        <div style="margin-bottom:15px;">
            <label for="nama_kegiatan" style="font-weight:600; display:block; margin-bottom:5px;">Nama Kegiatan</label>
        ...
        <div style="margin-bottom:15px;">
            <label for="template_path" style="font-weight:600; display:block; margin-bottom:5px;">Upload Template Surat</label>
            <input type="file" id="template_path" name="template_path" accept=".docx,.pdf"
                   style="width:100%; padding:8px; border:1px solid #ccc; border-radius:6px; font-size:1rem;">
            <small style="color:#6c757d;">File dapat berupa .docx</small>
        </div>
